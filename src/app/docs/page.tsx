        ...
        <main className="flex-1 bg-white rounded-lg shadow-sm p-8 max-w-4xl">
          ...
          <section id="overview" className="mb-16">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
              ...
              <code className="text-sm bg-white px-3 py-1 rounded text-gray-900">https://qr.scanalyzr.com/api/v1/public</code>
            </div>
...
{`fetch('https://qr.scanalyzr.com/api/v1/public/qr', {
  headers: {
  ...
  headers: {
    ...
    'Content-Type': 'application/json'
              ...
              <div className="border rounded-lg p-4 bg-yellow-50">
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded overflow-x-auto text-sm">
{`https://qr.scanalyzr.com/api/v1/public/qr?apiKey=qr_live_your_api_key_here`}
                </pre>
...
{`curl -X POST https://qr.scanalyzr.com/api/v1/public/qr \\
...
{`const createQRCode = async () => {
  const response = await fetch('https://qr.scanalyzr.com/api/v1/public/qr', {
    method: 'POST',
    headers: {
      'X-API-Key': 'qr_live_your_api_key_here',
      'Content-Type': 'application/json'
...
{`const getQRCodes = async (page = 1, limit = 10) => {
  const response = await fetch(
    \`https://qr.scanalyzr.com/api/v1/public/qr?page=\${page}&limit=\${limit}\`,
    {
      headers: {
        'X-API-Key': 'qr_live_your_api_key_here'
      }
...
{`const getQRCode = async (qrCodeId) => {
  const response = await fetch(
    \`https://qr.scanalyzr.com/api/v1/public/qr/\${qrCodeId}\`,
    {
      headers: {
        'X-API-Key': 'qr_live_your_api_key_here'
      }
...
{`const getAnalytics = async (qrCodeId) => {
  const response = await fetch(
    \`https://qr.scanalyzr.com/api/v1/public/qr/\${qrCodeId}/analytics\`,
    {
      headers: {
        'X-API-Key': 'qr_live_your_api_key_here'
      }
